...
export const INITIAL_CLIENTS: ClientProfile[] = [
  ...
  },
  {
    ...
    notes: 'Industrial warehouse lease contract expiring soon! Coordinate lease renewal agreement with IEN Realty Inc. executive board.',
    customFolders: [],
  ...
  },
  {
    ...
    status: 'Matured/Expired',
    notes: 'Contract matured on January 14, 2026. Needs immediate renewal or turnover clearance.',
    customFolders: [],
