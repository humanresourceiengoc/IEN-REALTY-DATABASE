...
export const MasterVerificationGate: React.FC<MasterVerificationGateProps> = ({
  ...
  // Master Admin Passcode / One-Tap Login
  const handleMasterPasscodeSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    setErrorMsg('');
    if (!masterPasscode) {
      setErrorMsg('Please enter the Master Passcode or PIN.');
      return;
    }
    ...
    setTimeout(() => {
      ...
      if (session) {
        ...
        setErrorMsg('Invalid Master Passcode. Please check or use Email Sign-in.');
      }
      setIsSubmitting(false);
    }, 300);
  };
  ...
  const handleFirebaseGoogleLogin = async () => {
    ...
    try {
      ...
      setErrorMsg('Google Sign-in was cancelled or encountered an issue. You can use Email Log In directly.');
    } finally {
      setIsSubmitting(false);
    }
  };
  ...
  const handleRefreshStatus = () => {
    ...
    if (isApproved) {
      ...
      setNotificationMsg('Verification approved! Database unlocked.');
    } else {
      setNotificationMsg('Verification still pending master administrator approval.');
  ...
  const handleSendUpdatedReason = () => {
    ...
    setNotificationMsg('Updated access reason submitted to Master Administrator!');
        ...
        <div className="max-w-lg w-full bg-slate-900 border border-slate-800 rounded-3xl p-6 sm:p-8 shadow-2xl relative z-10">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-base font-extrabold text-white">
                  {isRejected ? 'Access Request Declined' : 'Pending Database Verification'}
                </h2>
          ...
          <div className="bg-amber-950/40 border border-amber-500/30 rounded-2xl p-4 mb-5 text-xs space-y-2.5">
            <div className="flex items-center gap-2 text-amber-300 font-bold">
              ...
              <span>Master Administrator Approval Required</span>
            </div>
            <p className="text-slate-300 leading-relaxed">
              Ang access request para sa email na ito ay naipadala na sa <strong>Master Database Administrator</strong>.
            </p>
            <div className="p-2.5 bg-slate-900/90 rounded-xl border border-slate-800 flex items-center justify-between text-xs">
              <span className="font-medium text-slate-300">Target Authority:</span>
              <span className="font-bold text-amber-400 font-mono">Master Administrator (Protected)</span>
            </div>
            <p className="text-slate-400 text-[11px] leading-relaxed">
              Kapag na-verify at na-approve na ng Master Admin sa kanyang dashboard, <strong>awtomatikong bubukas</strong> ang portal sa iyong screen sa real-time nang hindi mo kailangang mag-refresh.
            </p>
          </div>
          ...
          <div className="mb-5">
            <label className="block text-xs font-semibold text-slate-300 mb-1.5">
              Add / Update Reason for Database Access:
            </label>
            <div className="flex gap-2">
              <input
                ...
                placeholder="e.g., Compliance Auditor / BIR Form 2303 Review"
          ...
          <div className="space-y-2.5 pt-2">
            ...
            <div className="flex flex-col sm:flex-row gap-2 pt-1">
              ...
              >
                ...
                <span>Log Out / Use Different Email</span>
              </button>
      ...
      <div className="max-w-md w-full bg-slate-900 border border-slate-800 rounded-3xl p-6 sm:p-8 shadow-2xl relative z-10">
        ...
        {authTab === 'email_login' && (
          <div className="space-y-4">
            <form onSubmit={handleEmailLoginSubmit} className="space-y-3.5">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="e.g. staff.compliance@company.com"
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="e.g. Maria Santos (Internal Auditor)"
              ...
              <div>
                <label className="block text-xs font-bold text-slate-300 mb-1.5">
                  Purpose / Reason for Database Access (Optional)
                </label>
                <input
                  type="text"
                  value={requestReason}
                  onChange={(e) => setRequestReason(e.target.value)}
                  placeholder="e.g. PCAB & BIR 2303 compliance verification"
                  className="w-full bg-slate-950 border border-slate-700 rounded-xl px-3 py-2.5 text-xs text-white placeholder:text-slate-500 focus:outline-none focus:border-sky-400"
                />
              </div>
              ...
              >
                ...
                <span>Log In & Request Database Access</span>
            ...
            <button
              ...
              className="w-full py-2.5 px-4 bg-slate-800 hover:bg-slate-750 text-slate-200 font-bold text-xs rounded-xl border border-slate-700 transition flex items-center justify-center gap-2.5"
            >
          ...
          <div className="space-y-4">
            <div className="p-3.5 bg-amber-950/30 border border-amber-500/30 rounded-2xl text-xs space-y-1.5">
              ...
              <p className="text-slate-300 text-[11px] leading-relaxed">
                Tanging ang authorized Master Owner lamang ang may access sa Gatekeeper controls at database verification.
              </p>
            </div>
            ...
            <form onSubmit={handleMasterPasscodeSubmit} className="space-y-3">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="Enter Master Passcode (e.g. ien2026)"
              ...
              >
                ...
                <span>Verify & Open Master Vault</span>
              </button>
            </form>
            ...
            <div className="pt-1">
              ...
              >
                ...
                <span>1-Click Owner Master Bypass</span>
              </button>
            </div>
          </div>
        )}
        ...
        <div className="mt-6 pt-4 border-t border-slate-800 text-center">
          <p className="text-[10px] text-slate-500 leading-relaxed">
            Strict Database Verification Active &bull; Master Email is protected and audited under IEN Realty Inc. privacy guidelines.
          </p>
        </div>
