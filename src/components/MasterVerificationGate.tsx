      ...
      <div className="max-w-md w-full bg-slate-900 border border-slate-800 rounded-3xl p-6 sm:p-8 shadow-2xl relative z-10">
        ...
        <div className="space-y-3">
          <button
            ...
            onClick={handleMasterOneClickLogin}
            className="w-full py-3.5 px-4 bg-gradient-to-r from-sky-500 to-sky-600 hover:from-sky-400 hover:to-sky-500 active:from-sky-600 active:to-sky-700 text-white font-bold text-xs sm:text-sm rounded-xl transition shadow-lg shadow-sky-500/25 flex items-center justify-center gap-2.5 group"
          >
            {/* Google Vector Icon */}
            ...
            <span>Continue as Master Google Owner</span>
          ...
          <div className="relative my-4">
            ...
            <div className="relative flex justify-center text-[10px] uppercase">
              <span className="bg-slate-900 px-3 text-slate-500 font-semibold tracking-wider">
                Or Connect Other Google Account
              </span>
            </div>
          </div>
